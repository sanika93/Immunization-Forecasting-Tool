    			...
    			<ul class="nav navbar-nav">
    				...
    				<li class="dropdown">
    					...
    					<ul class="dropdown-menu">
    						...
    						<li><a href="#">Immunization Details</a></li>
    				...
    				<li class="dropdown">
    					...
    					<ul class="dropdown-menu">
    						<li><a href="#">Personal Details</a></li>
    						<li><a href="AddImmunization.jsp" target="home">Immunization Details</a></li>
    				...
    				<li class="dropdown">
    					...
    					<ul class="dropdown-menu">
    						<li><a href="#">Personal Details</a></li>
    						<li><a href="View.jsp">Immunization Details</a></li>
    						<li><a href="#">Allergy Details</a></li>
    					</ul>
    				</li>
    				
    				<li class="dropdown">
    					<a href="#" class="dropdown-toggle" data-toggle="dropdown"><c:out value="${uName}"/><b class="caret"></b></a>
    					<ul class="dropdown-menu">
